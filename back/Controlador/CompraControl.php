<?php
    require_once "back/Modelo/envio.php";
    require_once "back/Modelo/venta.php";
    require_once "back/Modelo/carrito.php";
    require_once "back/Modelo/producto.php";
    class CompraControl{
        ...
        public function registrar_compra(){
            if (GeneralControl::V_Sesion("usuario") || GeneralControl::V_Sesion("admin")){
                ...
                if ($accion) {
                    ...
                    header("location: ".url_index."index.php?controlador=compra&accionar=envio");
                } else {
                    $_SESSION['mensaje']="Ocurrio un error en la compra";
                    header("location: ".url_index."index.php?controlador=compra&accionar=envio");}

            }else{
                $_SESSION['link_espera']="location: ".url_index."index.php?controlador=compra&accionar=registrar_compra";
